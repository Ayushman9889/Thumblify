    ...
    return (
        <div className="relative space-y-3 dark">
            ...
            <button
                ...
                py-3 text-left transition bg-white/5 border-white/10 text-zinc-200 
            ...
            {isOpen && (
                ...
                border-white/12 bg-black/20 shadow-lg backdrop-blur-3xl">
                    {thumbnailStyles.map((style) => (
                        <button 
                            ...
                            text-zinc-200 hover:bg-white/10 border-b border-white/5 last:border-0"
                        >
