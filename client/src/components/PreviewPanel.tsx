            ...
            ${aspectClasses[aspectRatio]}`}>
                ...
                {isLoading &&
                    ...
                    bg-black/25">
                        ...
                        <div>
                            <p className="text-sm font-medium text-zinc-200">AI is generating your preview...</p>
                            <p className="text-xs mt-1 text-zinc-400">This may take a few moments.</p>
                        </div>
                ...
                {!isLoading && thumbnail?.image_url && (
                    <div className="group relative h-full w-full">
                        ...
                        bg-black/10 opacity-0 transition-opacity group-hover:opacity-100">
                            <button
                            type="button"
                            className="mb-6 flex items-center gap-2 rounded-md px-5 py-2.5 text-sm
