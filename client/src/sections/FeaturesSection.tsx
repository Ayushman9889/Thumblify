    ...
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                {/* FIXED: Closed the p tag here */}
                <motion.p className="text-slate-300 text-lg text-left max-w-3xl mb-8"
                    initial={{ y: 150, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    viewport={{ once: true }}
                ...
                {/* ADDED: Grid container so col-span-2 works */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                        <img className="h-full w-auto object-cover rounded-xl" src="/assets/features-showcase-1.png" alt="features showcase" width={1000} height={500} />
                    </motion.div>
                    ...
                    >
                        <img src="/assets/features-showcase-2.png" alt="features showcase" width={1000} height={500} className="hover:-translate-y-0.5 transition duration-300 rounded-xl" />
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">boost your views with AI-optimised thumbnails</h3>
