...
const ThumbnailSchema = new mongoose.Schema<IThumbnail>(
    ...
    color_scheme: {type: String, trim: true, enum: ["vibrant" , "sunset" , "forest", "neon" , "purple" , "monochrome" , "ocean" , "pastel"], default: "16:9"},
...
const Thumbnail = mongoose.models.Thumbnail || mongoose.model<IThumbnail>(
